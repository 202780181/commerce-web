...
export const productDetailImagesDatabase: Record<string, string[]> = {
		...
		"HP15077 (Double Jaw)    .png",
		"HP15077 (Steel Jaw).png",
		"HP155130 (Aluminum Jaw) .png",
		"HP155130 (Double Station)    .png",
		"HP155130 (Steel Jaw).png",
		"HP255130 ( Base Series)    .png",
		"HP255130 (Aluminum Jaw) .png",
		"HP255130 (Double Station)    .png",
		"HP255130 (Steel Jaw) .png",
		"HP300160 ( Base Series)  .png",
		"HP300160 (Aluminum Jaw)    .png",
		"HP300160 (Double Station)    .png",
...
export function getProductDetailImages(productId: string) {
	...
	// CDN 基础 URL
	const baseUrl = "https://cdn.gzxfjxyxgs.com/pdf%E7%85%A7%E7%89%87";
	
	return imageNames.map(imageName => ({
		name: imageName.replace(/\.(png|jpg|jpeg|webp)$/i, ""),
