    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[50vh] min-h-[400px] bg-black overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src={
              config?.banners?.[0]?.image_url ||
              "/images/products/optimatia-landing-hero.webp"
            }
            alt="Background"
        ...
        <div className="max-w-[1600px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            >
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-gray-900 font-medium text-sm leading-relaxed">
                      {config?.configs?.contact_address ||
              ...
              {config?.recommend_products &&
                config.recommend_products.length > 0 && (
                  <motion.div
                    initial={{ opacity: 0, y: 30 }}
                    animate={{ opacity: 1, y: 0 }}
