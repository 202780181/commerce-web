...
const downloadFiles = [
	...
	},
	{
		...
		date: "2024-01-10",
		type: "PDF",
		description: "Detailed technical specifications and installation guide",
	...
	},
	{
		...
		date: "2023-12-20",
		type: "PDF",
		description: "Step-by-step user guide for all products",
	...
	},
	{
		...
		date: "2023-12-15",
		type: "ZIP",
		description: "Complete CAD drawings and 3D models",
		url: "/downloads/cad-drawings.zip"
	},
	{
		id: 5,
		...
		date: "2023-12-01",
		type: "PDF",
		description: "Product safety certifications and compliance documents",
		url: "/downloads/safety-cert.pdf"
	},
	{
		id: 6,
		...
		date: "2023-11-25",
		type: "MP4",
		description: "Video tutorial for product installation",
		url: "/downloads/installation-video.mp4"
	}
];
											...
											<div className="flex items-center justify-between gap-6">
												...
												<div className="flex-shrink-0">
													<motion.a
														...
														whileTap={{ scale: 0.95 }}
														className="inline-block px-8 py-2.5 bg-[#1e3a5f] text-white font-semibold rounded hover:bg-[#2d4a6f] transition-colors"
													>
														Download
													</motion.a>
												</div>
