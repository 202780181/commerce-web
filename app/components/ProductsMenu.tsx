  ...
  return (
    ...
    >
      <div 
        ...
        style={{
          backgroundImage: category.cover_url ? `url("${category.cover_url}?x-oss-process=image/quality,Q_50")` : undefined,
        }}
      >
        {!category.cover_url && (
...
const ProductsMenu = memo(({ isScrolled, lightBackground, pathname, categories }: ProductsMenuProps) => {
  ...
  const textColorClass = isScrolled || lightBackground ? 'text-gray-900' : 'text-white';
