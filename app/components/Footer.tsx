...
const socialContacts = [
  {
    id: "wechat",
    name: "WeChat",
    image: "/images/products/weixin.png",
    icon: (
  ...
  },
  {
    id: "instagram",
    name: "Instagram",
    image: "/images/products/instagram.png",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: "tiktok",
    name: "TikTok",
    image: "/images/products/tiktok.png",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              {socialContacts.map((social) => (
                ...
                >
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`w-8 h-8 rounded-full bg-gradient-to-br ${social.color} flex items-center justify-center cursor-pointer shadow-md hover:shadow-lg transition-all text-white`}
                  >
                    {social.icon}
                  </motion.div>
